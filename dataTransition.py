...
#TODO: replace checkCableTobt with check bt, do other things in main.py, also use pyautogui to find image?
	...
	while(1):
		...
		if x!= -1:
			...
			if color[0]<5 and color[1]>130 and color[2]<5:				#values close to the green color used, 
				...
				wait=0													#wait for switch back to cable, should be quick
				while(1):
