...
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,16,0,"refInput");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,17,0,"a");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,18,0,"b");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,19,0,"c");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,20,1,"d");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (2,21,1,"e");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (2,22,1,"f");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (2,23,1,"g");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (3,24,0,"h");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (3,25,0,"i");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (3,26,0,"j");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (3,27,1,"k");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (3,28,1,"l");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (2,29,1,"m");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,30,1,"n");
INSERT INTO inputs (testId,inputId,bip,inputName) VALUES (1,31,0,"o");
